...
f, ax = plt.subplots(len(example_subjects),2, figsize=(cfg.fig_width['two_column']*1.5,cfg.fig_width['two_column']*2.085/5*2), gridspec_kw={'width_ratios': [6,3]})
for n_idx, n in enumerate(example_subjects):
    # Get data
...
plt.tight_layout()
print("Saving png...")
plt.savefig(save_dir + "S_visual_artifacts_good.png")
